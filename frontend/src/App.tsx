...
export default function App() {
  ...
  function updateMechanism(next: MechanismDraft) {
    ...
    setMessage(next.kind === 'sliding_lid'
      ? 'Le couvercle coulissant est prepare pour un essai. Le plan ne bouge pas et aucun rail n est encore cree dans Fusion.'
