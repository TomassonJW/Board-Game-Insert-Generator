...
- Ajout de garde-fous hors Fusion : cavite inconnue, placement unsupported,
  debordement de cavite, hauteur excessive et epaisseur frontale insuffisante.
- Ajout de l'execution Fusion par sketch XZ + `CutFeatureOperation` limite au
  body cible via `participantBodies`.
- Documentation de la procedure de smoke test manuel P6-M002.

## Statut de validation

- Code et tests hors Fusion : OK, 100 tests unitaires passes et CLI/export CAD IR valides.
- Validation Fusion manuelle : requise pour P6-M002V.
- Validation impression 3D : non realisee.

## Limites

Une `half_moon_notch` n'est pas encore une demi-lune courbe dans Fusion. P6-M002
cree uniquement une coupe rectangulaire frontale correspondant a sa bounding box.
