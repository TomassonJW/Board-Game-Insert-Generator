...
Rapport V0 : politique `fusion_only_stl_per_printable_module_v0`, format `stl`, dossier export, compteurs detectes/exportes/refuses, fichiers exportes, refus avec raisons, `manifest_json`, `manifest_markdown`, `print_validated: false`.
