...
- Statut : `done-baseline-and-thresholds-frozen`, dépend de P64-L09W-D-N.
...
- Baseline : 16/16, 80 calculs, zéro échec fonctionnel ; seuils robustes 99 %
  corrigés par Bonferroni, sans marge fixe.
- Prochaine utilisation : sentinelles sur un changement causal de recherche,
  puis 48 cas seulement si le signal est prometteur.
...
- P64-L09S-B : `completed`.
- P64-L09S-C : `ready`.
- P64-L09S-D a F : attente sequentielle.
- P64-L09S-V : gate Fusion humaine.
...
- Dépendance : P44-M009H03 intégrée ; revue Fusion 0.1.34 non acceptée sur la composition UI.
- Capability : C-FUSION-UI, C-USABILITY, C-QUALITY.
- Réglages : bloc 760 px maximum, tableau 590 px maximum, champs alignés à gauche.
- Conteneurs : identité compacte, minimum et mode bornés, épaisseurs clarifiées, dimensions Cible/Fixe intégrées dans l’en-tête, interversion entre X et Y, aucune interversion en Auto.
...
- Capability : C-FUSION-UI, C-USABILITY et C-QUALITY.
- Dépendances : P44-M001 à P44-M009 terminées selon leurs contrats ; P0-M010 terminé.
