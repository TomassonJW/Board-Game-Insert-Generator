...
| C-ASSET | Asset model | Asset-first design | `implemented-cad-ir` | M6 Asset-first project model | Assets charges/reportes P9-M002; module_candidates metadata P10-M004; gate si derivation automatique executable ou schema incompatible |
...
| C-SOLVER | Solver and scoring | Volumetric layout | `implemented-core` | M10 Semi-automatic solver | Variant comparison P10-M002 report-only; raisons de rejet structurees P10-M003; module_candidates P10-M004; gate architecture si optimiseur majeur |
