...
| C-ASSET | Asset model | Asset-first design | `implemented-cad-ir` | M6 Asset-first project model | Assets charges/reportes P9-M002; module_candidates metadata P10-M004/P10-M005; grouping borne P10-M006; plan executable borne P10-M008; P13-M001 ajoute une saisie `quick_asset_box` depuis Fusion, implementee mais en attente de validation humaine P13-M001V; apres KO partiel, la V0 declare explicitement assets non visualises, cavites non generees et sizing non count-aware; P13-M002 devra traiter la capacite count-aware; gate si schema incompatible, solveur complexe ou Fusion avancee |
...
| C-SOLVER | Solver and scoring | Volumetric layout | `implemented-core` | M10 Semi-automatic solver | Variant comparison P10-M002 report-only; raisons de rejet structurees P10-M003; module_candidates P10-M004; variante recommandee P10-M005; grouping borne P10-M006; plan concret greedy P10-M008; P13-M001 reutilise ce pipeline sans backtracking ni optimisation globale; gate architecture si optimiseur majeur |
