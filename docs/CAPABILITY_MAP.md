...
| C-FUSION-UI | Fusion command UI | CAD generation pipeline | `fusion-validated` | M14 Usable beta | P11-M003 ajoute une commande Fusion minimale avec chemin CAD IR et mode compact/exploded; P11-M003V/P11-M003V2 KO partiels; P11-M003V3 corrige command id, handlers, bouton toolbar optionnel et ouverture du dialogue; P11-M003V4 valide l'usage UI avec scene produit non ambigue, `Module source mapping` et `Body sizing report`; P12-M001 implemente le bouton toolbar relancable sans redemarrage add-in, validation Fusion requise; pas de palette persistante ni UI produit complete; print-validated: false |
