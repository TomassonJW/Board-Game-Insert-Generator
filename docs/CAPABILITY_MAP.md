...
| C-FUSION-EXPLODED | Fusion exploded view | CAD generation pipeline | `implemented-fusion` | M5 CAD inspection views | P7-M001 code une vue eclatee basique corrigee par composants uniques et occurrences compactes/eclatees liees; smoke test P7-M001V2 requis; print-validated: false |
