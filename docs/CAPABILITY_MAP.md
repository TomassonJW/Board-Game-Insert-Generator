...
| C-ASSET | Asset model | Asset-first design | `fusion-validated-v0` | M6 Asset-first project model | Assets charges/reportes P9-M002; module_candidates metadata P10-M004/P10-M005; grouping borne P10-M006; plan executable borne P10-M008; P13-M001/P13-M001V valide Fusion une saisie `quick_asset_box` V0 honnete avec module proxy asset-first, assets lus depuis l UI, generate/regenerate/clear, diagnostics de limites, assets non visualises, cavites non generees et sizing non count-aware; P13-ASSET-M002 devra traiter la capacite count-aware si autorisee; gate si schema incompatible, solveur complexe ou Fusion avancee |
