...
- C-FUSION-UI : `fusion-validated` pour reporting count-aware, `storage_sizing` et sketch debug asset-fit non imprimable ; gate Fusion active `P13-ASSET-M003V`.

## P13-ASSET-M003 capability update

- C-ASSET : `implemented-fusion-adapter` pour une cavite asset-fit globale issue de l'enveloppe count-aware, validation Fusion requise.
- C-FUSION-CAVITIES : reuse de `subtract_rectangular_cavity` pour les modules `executable_asset_plan`, sans nouvelle geometrie complexe.
- C-FUSION-UI : `quick_asset_box` prepare le smoke M003 avec reporting `asset_cavity_policy`, compteurs planned/generated et diagnostics de fond/murs.
- C-SOLVER : inchang? ; aucune optimisation globale, aucun backtracking, aucune cavite par pile.
