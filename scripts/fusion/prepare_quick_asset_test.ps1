...
Write-Output "7. Run generation and verify Quick asset box inputs, assets_read, asset_items_visualized: no, asset_cavities_generated: yes, asset_cavity_policy: single_asset_fit_rectangular_cavity_v0, asset_fit_cavities_planned: 1, count_aware_storage_sizing: yes, asset_debug_visualization: yes, asset_sizing capacity_per_stack/pile_count diagnostics, module_candidate_sizing declared_capacity and module_size 50.0 x 39.0 x 48.0, asset_cavity size 47.6 x 36.6 x 46.8 mm, retained_floor 1.2 mm, expected walls 1.2 mm, Reference outline policy: bottom_and_top_box_xy_outlines, Body sizing report, Registry validation: ok, and Print validation: false."
