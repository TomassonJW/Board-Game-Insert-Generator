...
Write-Output "7. Run generation and verify Quick asset box inputs, assets_read, module_candidates_generated, placed_asset_modules, Body sizing report, Registry validation: ok, and Print validation: false."
