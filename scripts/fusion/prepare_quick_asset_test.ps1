...
Write-Output "7. Run generation and verify Quick asset box inputs, assets_read, asset_items_visualized: no, asset_cavities_generated: yes, asset_cavity_policy: per_source_asset_rectangular_compartments_v0, asset_fit_cavities_planned: 2, asset_compartments_generated: yes, asset_compartment_cavities_planned: 2, asset_compartment_debug_outlines: yes, asset_access_features_generated: yes, asset_access_policy: per_compartment_top_open_rectangular_notch_v0, asset_access_notches_planned: 2, asset_access_notches_generated: 2, asset_access_notches_refused: 0, count_aware_storage_sizing: yes, asset_debug_visualization: yes, asset_sizing capacity_per_stack/pile_count diagnostics, module_candidate_sizing declared_capacity and module_size 52.8 x 39.0 x 48.0, two asset_cavity entries for coin-tokens and status-tokens, two real top-open rectangular asset access notch cuts on the front wall, cavity sizes about 37.6 x 17.6 x 46.8 mm and 11.6 x 36.6 x 46.8 mm, retained_floor 1.2 mm, internal_wall 1.2 mm on the second compartment, Reference outline policy: bottom_and_top_box_xy_outlines, Body sizing report, Registry validation: ok, and Print validation: false."
