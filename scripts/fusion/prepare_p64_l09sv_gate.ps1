...
Write-Output "4. Open CasLimite01 with its 18 containers and central tray; calculate in Normal and observe a one-second gauge without jumps or freezes. Require a certified solution without imposing one winning lane."
Write-Output "5. Finalize CasLimite01 in Normal; require every source minimum and fixed axis, no artificial tray-support growth, zero printable residual, then materialize all 18 containers without false success."
Write-Output "6. Open CasLimite02 with tray and booklet; calculate in Normal, confirm the upright-card cavity is 63.6 mm, then finalize in Quick."
Write-Output "7. Materialize CasLimite02 and require a 67.6 mm final upright-card cavity with a 2.2 mm floor, unions before exact cuts and one user component per owner."
