...
Write-Output "3. In the UI settings block, confirm UI settings loaded: yes and Loaded generation mode = $GenerationMode."
Write-Output "4. Confirm Input mode = cad_ir_file, Action = generate, Generation mode = $GenerationMode."
Write-Output "5. Confirm CAD IR path = $cadIrPath."
Write-Output "6. Click Run and verify registry ok, expected occurrences, Body sizing report, and Print validation: false."
