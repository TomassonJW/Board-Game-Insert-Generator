...
Write-Output "5. Click Run and verify one open-top tray per selected module, with four walls, a retained floor and one top-open cavity in compact scene positions."
Write-Output "6. Confirm the result is only a Fusion smoke: no print validation or physical fit is claimed."
