...
Write-Output "4. Check the compact scene: 3 named storage trays, one tall empty support tray, one separator, grouped automatic fillers, their top-open cavities, and one reference-box outline."
