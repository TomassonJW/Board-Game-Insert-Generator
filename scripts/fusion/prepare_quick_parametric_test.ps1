...
Write-Output "4. Confirm Loaded input mode = quick_parametric_box and Loaded generation mode = compact_only."
Write-Output "5. Confirm loaded quick box values: box 120 x 80 x 30, grid 4 x 4 x 3, wall/floor 1.2, clearances 0.4 / 0.3, profile draft."
Write-Output "6. Confirm Input mode = quick_parametric_box and Action = generate, or regenerate if a BGIG scene already exists."
Write-Output "7. Run generation, reopen BGIG, confirm all values are rehydrated."
Write-Output "8. Change box_inner_x_mm to 160, set Action = regenerate, run."
Write-Output "9. Reopen BGIG and confirm 160 is still present."
