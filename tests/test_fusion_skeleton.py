...
class FusionSkeletonTests(unittest.TestCase):
    ...
    def test_builds_quick_asset_box_request_config_and_cad_ir_payload(self) -> None:
        ...
        self.assertIn("no physical print validation", printability["warnings"][0])
        ...
        self.assertEqual(module_diagnostic["module_size_mm"], {"x": 102.8, "y": 24.0, "z": 22.0})
        self.assertEqual(module_diagnostic["asset_fit_size_mm"], {"x": 100.4, "y": 21.6, "z": 20.8})
        ...
        self.assertEqual(cavity_diagnostic["size_mm"], {"x": 61.6, "y": 21.6, "z": 20.8})
        ...
        self.assertEqual(cut.cut_size_mm.to_dict(), {"x": 61.6, "y": 21.6, "z": 20.8})
        ...
        self.assertIn("module_size 102.8 x 24.0 x 22.0 mm", summary)
