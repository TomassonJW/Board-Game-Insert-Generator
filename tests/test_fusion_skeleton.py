...
class FusionSkeletonTests(unittest.TestCase):
    ...
    def test_builds_quick_asset_box_request_config_and_cad_ir_payload(self) -> None:
        ...
        self.assertEqual(quick_metadata["asset_access_notches_planned"], 1)
        self.assertEqual(quick_metadata["asset_access_notches_generated"], 1)
        self.assertEqual(quick_metadata["asset_access_notches_refused"], 1)
        ...
        self.assertEqual(cavity_diagnostic["size_mm"], {"x": 101.6, "y": 41.6, "z": 10.8})
        self.assertEqual(cavity_diagnostic["retained_floor_mm"], 1.2)
        self.assertEqual(cavity_diagnostic["expected_walls_mm"], {"x_min": 1.2, "x_max": 1.2, "y_min": 1.2, "y_max": 22.0})
        ...
        self.assertEqual(cut.cut_size_mm.to_dict(), {"x": 101.6, "y": 41.6, "z": 10.8})
        ...
        self.assertIn("asset_access_notches_planned: 1", summary)
        self.assertIn("asset_access_notches_generated: 1", summary)
        self.assertIn("asset_access_notches_refused: 1", summary)
        ...
        self.assertIn("module_size 104.0 x 64.8 x 12.0 mm", summary)
