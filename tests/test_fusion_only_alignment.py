...
class FusionOnlyAlignmentTests(unittest.TestCase):
    ...
    def test_next_action_exposes_the_current_ui_density_gate_without_promoting_print(self) -> None:
        ...
        self.assertIn("P44-M009H04", actions)
        self.assertIn("0.1.35", actions)
        self.assertIn("P44-M009H04V", actions)
        self.assertIn("P44-M009H04 Fusion OK 0.1.35 - commit <sha>", actions)
        ...
        self.assertNotIn("P44-M009H03 Fusion OK 0.1.34 - commit <sha>", actions)
