...
class FusionOnlyAlignmentTests(unittest.TestCase):
    ...
    def test_next_action_exposes_the_current_global_clearance_gate_without_promoting_print(self) -> None:
        ...
        self.assertIn("P44-M009H03", actions)
        self.assertIn("0.1.34", actions)
        self.assertIn("P44-M009H03V", actions)
        self.assertIn("P44-M009H03 Fusion OK 0.1.34 - commit <sha>", actions)
        ...
        self.assertNotIn("P44-M009H02 Fusion OK 0.1.33 - commit <sha>", actions)
